...
@Component({
  selector: 'app-tela-pessoal',
  templateUrl: './tela-pessoal.component.html',
  styleUrls: ['./tela-pessoal.component.css']
})
export class TelaPessoalComponent implements OnInit {
