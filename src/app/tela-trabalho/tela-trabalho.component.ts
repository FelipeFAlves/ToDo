...
@Component({
  ...
  templateUrl: './tela-trabalho.component.html',
  styleUrls: ['./tela-trabalho.component.css']
})
export class TelaTrabalhoComponent implements OnInit {
  ...
  Tabela() {
    //Pegar o id do usuário
    var usuario = JSON.parse(localStorage.getItem('user')!)['uid'];
    this.afs.trabalho(usuario).subscribe((tarefas) => {
