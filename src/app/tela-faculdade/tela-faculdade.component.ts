...
@Component({
  selector: 'app-tela-faculdade',
  templateUrl: './tela-faculdade.component.html',
  styleUrls: ['./tela-faculdade.component.css']
})
export class TelaFaculdadeComponent implements OnInit {
